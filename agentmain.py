...
from tools import GenericAgentHandler, smart_format, get_global_memory, format_error, consume_file

# 根目录
script_dir = os.path.dirname(os.path.abspath(__file__))
def load_tool_schema(suffix=''):
    global TOOLS_SCHEMA
    TS = open(os.path.join(script_dir, f'tools/tools_schema{suffix}.json'), 'r', encoding='utf-8').read()
